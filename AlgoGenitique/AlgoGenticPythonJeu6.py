...
output_file = "genetic_optimization_results6.txt"
...
train_data = pd.read_csv("C:/Users/malle/OneDrive/Bureau/Algo_optimisation_hyperparam/cardio_train.csv" , sep=';')

f_train = train_data.drop(columns=['id'])

# Diviser l'âge par 365
train_data['age'] = train_data['age'] / 365

# Diviser la hauteur par 100

...
output_file = "genetic_optimization_results5.txt"
...
train_data = pd.read_excel("C:/Users/malle/OneDrive/Bureau/Algo_optimisation_hyperparam/A_instance.xlsx")
# Vérifier si la variable cible est en format chaîne et la convertir
if train_data['target'].dtype == object:
    train_data['target'] = train_data['target'].map(lambda x: 1 if x == "VRAI" else 0)
